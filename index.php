...
<div class="row row-padding author">
    ...
    <img loading="lazy" src="<?php echo wp_get_attachment_url(get_theme_mod('pixelo-basic-author-callout-image')) ?>" alt="Author Image">
    </div>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(['row', 'row-padding']); ?>>
